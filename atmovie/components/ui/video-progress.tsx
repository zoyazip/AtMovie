...
export const VideoProgress = ({progress, scrub, videoDuration}: VideoProgressProps) => {
  ...
  const replicas: IReplica[] = [
    ...
    {
      color: "bg-user-cyan",
      width: timeToWidth({startAt: 49, endAt: 50, duration: videoDuration}),
      margin: timeToMargin({startAt: 49, endAt: 49, duration: videoDuration}, {startAt: 0, endAt: 49, duration: videoDuration}),
      percentage: [49, 50]
    },
    {
      color: "bg-user-cyan",
      width: timeToWidth({startAt: 50, endAt: 52, duration: videoDuration}),
      margin: timeToMargin({startAt: 50, endAt: 50, duration: videoDuration}, {startAt: 0, endAt: 50, duration: videoDuration}),
      percentage: [50, 52]
    },
    {
      color: `bg-user-red`,
